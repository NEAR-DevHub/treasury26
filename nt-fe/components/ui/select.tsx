        ...
        <SelectPrimitive.Portal>
            <SelectPrimitive.Content
                ...
                className={cn(
                    ...
                    // Exclusive: in footer mode the Viewport scrolls and the
                    // Content clips, so leaving both overflow sets on would
                    // let CSS source order decide which one applies.
                    footer
