 ...
 */
export function useTreasuryConfig(treasuryId: string | null | undefined, at: string | null | undefined = null) {
  return useQuery({
    queryKey: ["treasuryConfig", treasuryId, at],
    queryFn: () => getTreasuryConfig(treasuryId!, at),
    enabled: !!treasuryId,
    staleTime: 1000 * 60 * 5, // 5 minutes
  });
}
 ...
 */
export function useTreasuryPolicy(treasuryId: string | null | undefined, at: string | null | undefined = null) {
  return useQuery({
    queryKey: ["treasuryPolicy", treasuryId, at],
    queryFn: () => getTreasuryPolicy(treasuryId!, at),
    enabled: !!treasuryId,
