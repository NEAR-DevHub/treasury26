...
//! series, day-partitioned). All reads go through [`TokenPriceService`],
//! which normalizes the token-id formats used across the codebase to the
//! canonical defuse asset id.
