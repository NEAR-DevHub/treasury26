-- Add public treasury flow metrics to the NocoDB analytics view.
--
-- Public flows come from the gold public history projection
-- (gold_public_history_events) instead of the large balance_changes table,
-- mirroring how confidential flows are sourced from
-- gold_confidential_history_events. Public AUM stays sourced from
-- public_dashboard_daily_balances.
...
public_flows AS (
    ...
    FROM gold_public_history_events gpe
    JOIN monitored_accounts ma
