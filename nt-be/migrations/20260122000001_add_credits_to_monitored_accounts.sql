...
ALTER TABLE monitored_accounts
    ADD COLUMN export_credits INTEGER NOT NULL DEFAULT 10,
    ADD COLUMN batch_payment_credits INTEGER NOT NULL DEFAULT 120;

-- Grant credits to existing accounts (retroactive)
UPDATE monitored_accounts
SET export_credits = 10, batch_payment_credits = 120
WHERE export_credits = 0 OR batch_payment_credits = 0;
